[合集 - 从零开始学flink(4)](https://github.com)

1.从零开始学Flink：数据输出的终极指南10-06

[2.从零开始学Flink：揭开实时计算的神秘面纱06-08](https://github.com/daimajiangxin/p/18919412)[3.从零开始学Flink：数据源09-18](https://github.com/daimajiangxin/p/19098967)[4.从零开始学Flink：数据转换的艺术09-23](https://github.com/daimajiangxin/p/19106752):[wgetcloud](https://changshuaijiao.org)
...
public class FileSystemSinkDemo {
    public static void main(String[] args) throws Exception {
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        DataStream stream = env.fromData("Hello", "Flink", "FileSystem", "Sink");
...
源文来自：[http://blog.daimajiangxin.com.cn](https://github.com)

源码地址：[https://gitee.com/daimajiangxin/flink-learning](https://github.com)
